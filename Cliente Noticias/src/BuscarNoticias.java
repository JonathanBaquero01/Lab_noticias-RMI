 ...
 * @author Jona
 */
public class BuscarNoticias extends javax.swing.JFrame {

  private Interfaces service;
     
    public BuscarNoticias(Interfaces service) {
        initComponents();
        ...
        try {
            ...
            String Respuesta= BuscarNoticia(NombreNoticia);
...
LeerNoticia leernoticia = new  LeerNoticia(service, jTextFieldNoticia_A_Leer.getText());
leernoticia.setVisible(true);
if("Admin".equals(this.getTitle())){
leernoticia.setTitle("Admin");
}
this.dispose();
    }//GEN-LAST:event_jButtonOKActionPerformed

    public String BuscarNoticia(String NombreNoticia) throws RemoteException{
       String Respuesta_LeerNoticia = service.BuscarNoticia(NombreNoticia);
